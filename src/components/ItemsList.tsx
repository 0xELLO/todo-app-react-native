...
import { IListItem } from '../util/IListItem';

const ItemsList = <TEntity extends IListItem, >(props: {
  data: TEntity[],
      ...
      <TouchableOpacity
        ...
        <View style={mainStyles.block}>
          ...
          <>
            ...
            <Pressable onPress={() => {setOpenEdit(false); item.setName(name); props.updateData(item);}}>
